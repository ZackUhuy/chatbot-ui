...
AS $$
DECLARE
  project_url TEXT := 'https://ingumzwogwwefzmqwgvn.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImluZ3VtendvZ3d3ZWZ6bXF3Z3ZuIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4MTYxMjQ2NiwiZXhwIjoyMDk3MTg4NDY2fQ.ObGpQzz4wrvprxVwBLx-luKDFlOKMCQA5qS_sZFYewk'; -- full access needed for http request to storage
